...
public class FinishFragment extends Fragment {
    ...
    Button btn_back_toquiz;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view= inflater.inflate(R.layout.fragment_finish, container, false);
         textView = view.findViewById(R.id.tv_point);
         textView.setText(String.valueOf(StartFragment.point));
        btn_back_toquiz = view.findViewById(R.id.btn_backtoquiz);
        btn_backtomain = view.findViewById(R.id.btn_backtomain);
        ...
        btn_back_toquiz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
